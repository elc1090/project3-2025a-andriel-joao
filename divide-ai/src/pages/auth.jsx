...
import { Box, Container, Button, Paper, Slide } from '@mui/material';
      ...
      if (etapa === "inicio") {
        return (
          <Box key="inicio" sx={{height: 200}}>
            ...
            <h1 style={{fontFamily: "'Jersey 15'", color: "white", fontSize: 40, marginBottom: 10, textAlign: 'center'}}>ou</h1>
            <Button
              variant="outlined"
              fullWidth
